...
With this information, we're going to take it and interpret it with a series of plots and numbers. In the barchart we compare the two groups of nonaids and aids with a placebo and aids vaccine. We are going to identify percentages and the difference between the two groups and two variables. 
### Graphical results
...
Looking the barchart, in the first group, "none," it is a 50/50 distribution of the two types of vaccines. In the second group, "aids," 40% received the aids vaccine and 60% received a placebo vaccine. In the first group there was not a significant difference between the two vaccines. In the second group the placebo vaccine made a significant difference with those that had aids. Those that received the vaccine in the second group lessened the number of people that had aids to begin with.
...
There are two tables, we're looking at the bottom table, row percents. Among the people with aids, 40% had the vaccine and 60% had the placebo. This created a significant difference.
...
The vaccine had no effect on those with aids.

Our alternative hypothesis:

The vaccine had an effect on those with aids.

The p-value is less than 0.05% which means we reject the null hypothesis. This means that vaccine had an effect on whether one contracted aids or not.
